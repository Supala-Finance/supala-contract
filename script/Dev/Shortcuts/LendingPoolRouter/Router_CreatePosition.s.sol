...
contract Router_CreatePosition is Script, Helper, SelectRpc {
    ...
    function run() public {
        ...
        vm.broadcast();
        address position = lpRouter.createPosition(user);
...
// RUN
// forge script Router_CreatePosition --rpc-url <RPC_URL> --broadcast --private-key <PRIVATE_KEY> -vvv
