...
contract Router_RepayWithSelectedToken is Script, Helper, SelectRpc {
    ...
    function run() public {
        ...
        vm.broadcast();
        uint256 repayAmount = lpRouter.repayWithSelectedToken(shares, user);
...
// RUN
// forge script Router_RepayWithSelectedToken --rpc-url <RPC_URL> --broadcast --private-key <PRIVATE_KEY> -vvv
