...
contract Router_SupplyLiquidity is Script, Helper, SelectRpc {
    ...
    function run() public {
        ...
        vm.broadcast();
        uint256 shares = lpRouter.supplyLiquidity(amount, user);
...
// RUN
// forge script Router_SupplyLiquidity --rpc-url <RPC_URL> --broadcast --private-key <PRIVATE_KEY> -vvv
