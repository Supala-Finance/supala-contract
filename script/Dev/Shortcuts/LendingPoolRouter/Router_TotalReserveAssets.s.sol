...
contract Router_TotalReserveAssets is Script, Helper, SelectRpc {
    ...
    function run() public view {
        ...
        uint256 totalReserveAssets = lpRouter.totalReserveAssets();

        console.log("Router Address:", router);
        console.log("Total Reserve Assets:", totalReserveAssets);
    }
}

// RUN
// forge script Router_TotalReserveAssets -vvv
