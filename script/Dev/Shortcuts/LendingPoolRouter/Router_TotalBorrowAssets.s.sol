...
contract Router_TotalBorrowAssets is Script, Helper, SelectRpc {
    ...
    function run() public view {
        ...
        uint256 totalBorrowAssets = lpRouter.totalBorrowAssets();
...
// RUN
// forge script Router_TotalBorrowAssets -vvv
