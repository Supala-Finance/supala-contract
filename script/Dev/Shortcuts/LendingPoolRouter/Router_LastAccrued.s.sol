...
contract Router_LastAccrued is Script, Helper, SelectRpc {
    ...
    function run() public view {
        ...
        uint256 lastAccrued = lpRouter.lastAccrued();

        console.log("Router Address:", router);
        console.log("Last Accrued:", lastAccrued);
    }
}

// RUN
// forge script Router_LastAccrued -vvv
