...
contract Router_UserBorrowShares is Script, Helper, SelectRpc {
    ...
    function run() public view {
        ...
        uint256 userBorrowShares = lpRouter.userBorrowShares(user);

        console.log("Router Address:", router);
        console.log("User Address:", user);
        console.log("User Borrow Shares:", userBorrowShares);
    }
}

// RUN
// forge script Router_UserBorrowShares -vvv
