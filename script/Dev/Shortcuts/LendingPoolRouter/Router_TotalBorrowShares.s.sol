...
contract Router_TotalBorrowShares is Script, Helper, SelectRpc {
    ...
    function run() public view {
        ...
        uint256 totalBorrowShares = lpRouter.totalBorrowShares();
...
// RUN
// forge script Router_TotalBorrowShares -vvv
