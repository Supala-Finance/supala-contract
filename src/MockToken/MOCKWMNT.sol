...
/**
 * @title MOCKWMNT
 * @notice Mock Wrapped Mantle token for testing purposes
 * @dev Implements WMNT functionality with additional mint/burn capabilities for testing
 */
contract MOCKWMNT {
    /// @notice Token name
    string public name = "Wrapped Mantle";
