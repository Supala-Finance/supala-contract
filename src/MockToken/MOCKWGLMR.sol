...
/**
 * @title MOCKWGLMR
 * @notice Mock Wrapped Glimmer token for testing purposes
 * @dev Implements WGLMR functionality with additional mint/burn capabilities for testing
 */
contract MOCKWGLMR {
    /// @notice Token name
    ...
    /// @notice Token decimals (18 for Glimmer)
    ...
    /// @notice Emitted when native GLMR is deposited and wrapped
    /// @param dst Address receiving wrapped tokens
    /// @param wad Amount deposited
    event Deposit(address indexed dst, uint256 wad);

    /// @notice Emitted when wrapped tokens are withdrawn to native GLMR
    ...
    /**
     * @notice Receive function to accept GLMR and wrap it
     * @dev Automatically calls deposit() when GLMR is sent
     */
    ...
    /**
     * @notice Fallback function to accept GLMR and wrap it
     * @dev Automatically calls deposit() when GLMR is sent with data
     */
    ...
    /**
     * @notice Deposits native GLMR and mints equivalent wrapped tokens
    ...
    /**
     * @notice Withdraws wrapped tokens and receives native GLMR
     * @param wad Amount of wrapped tokens to withdraw
     * @dev Burns wrapped tokens and transfers equivalent GLMR to sender
     */
     ...
     * @dev Only for testing - increases supply without GLMR backing
     */
     ...
     * @dev Only for testing - decreases supply without GLMR withdrawal
     */
