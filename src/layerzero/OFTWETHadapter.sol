 ...
 * @notice LayerZero OFT Adapter for Wrapped ETH token cross-chain transfers
 * @dev Enables bridging of WETH tokens between chains with lock/unlock on source chain (8217) and mint/burn on destination chains
 */
contract OFTWETHadapter is OFTAdapter, ReentrancyGuard, ChainSettlement {
    ...
    /**
     * @notice Constructs the OFT WETH Adapter
     * @param _token Address of the WETH token
     ...
     * @return Number of shared decimals (18 for WETH)
     */
