 ...
 * @notice LayerZero OFT Adapter for Wrapped BTC token cross-chain transfers
 * @dev Enables bridging of WBTC tokens between chains with lock/unlock on source chain (8217) and mint/burn on destination chains
 */
contract OFTWBTCadapter is OFTAdapter, ReentrancyGuard, ChainSettlement {
    ...
    /**
     * @notice Constructs the OFT WBTC Adapter
     * @param _token Address of the WBTC token
     ...
     * @return Number of shared decimals (8 for WBTC, matching Bitcoin standard)
     */
