 ...
 * @notice LayerZero OFT Adapter for USDC token cross-chain transfers
 * @dev Enables bridging of USDC tokens between chains with lock/unlock on source chain (8217) and mint/burn on destination chains
 */
