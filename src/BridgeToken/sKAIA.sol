...
/**
 * @title sKAIA
 * @notice Synthetic KAIA token representing KAIA deposits in the Supala protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 18 decimals
 */
contract sKAIA is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the sKAIA token contract
     * @dev Initializes with name "KAIA representative backed by Supala" and symbol "sKAIA"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("KAIA representative backed by Supala", "sKAIA");
