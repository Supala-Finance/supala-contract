...
/**
 * @title sWETH
 * @notice Synthetic Wrapped ETH token representing WETH deposits in the Supala protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 18 decimals
 */
contract sWETH is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the sWETH token contract
     * @dev Initializes with name "Wrapped ETH representative" and symbol "sWETH"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("Wrapped ETH representative", "sWETH");
