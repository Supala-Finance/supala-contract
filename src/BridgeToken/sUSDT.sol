...
/**
 * @title sUSDT
 * @notice Synthetic USDT token representing USDT deposits in the Supala protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 6 decimals to match USDT
 */
contract sUSDT is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the sUSDT token contract
     * @dev Initializes with name "USD Tether representative" and symbol "sUSDT"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("USD Tether representative", "sUSDT");
