...
/**
 * @title sWBTC
 * @notice Synthetic Wrapped BTC token representing WBTC deposits in the Supala protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 8 decimals to match Bitcoin
 */
contract sWBTC is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the sWBTC token contract
     * @dev Initializes with name "Wrapped BTC representative" and symbol "sWBTC"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("Wrapped BTC representative", "sWBTC");
